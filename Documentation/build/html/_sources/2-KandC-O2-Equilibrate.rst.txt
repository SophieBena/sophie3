...
With rhyolite-MELTS and :math:`\mu`\ O2 constrained using the empirical method of Kress and Carmichael (1991)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This notebook demonstates the use of the Equilibrate class in the
...
or Ghiorso and Gualda (2015) [rhyoliteMELTS + CO2].

**References:**

Ghiorso, Mark S., and Sack, Richard O. (1995) Chemical Mass Transfer in
...
Ghiorso, Mark S., Hirschmann, Marc M., Reiners, Peter W., and Kress,
...
Geophysics, Geosystems 3(5), 10.1029/2001GC000217

Gualda G.A.R., Ghiorso M.S., Lemons R.V., Carley T.L. (2012)
...
Ghiorso M.S., Gualda, G.A.R., (2015) An H2O-CO2 mixed fluid saturation
model compatible with rhyolite-MELTS. Contributions to Mineralogy and
Petrology 2015, doi:10.1007/s00410-015-1141-8
...
and Petrology 108:82-92

**Note** that the method demonstrated in this notebook should ideally be
cast into a proper Khorzhinskii potential minimization, as is done for
the :math:`\mu`\ H2O constraint method illustrated in the next notebook.
...
here mimics the method used in MELTS, etc.
...
These 15 elements are required for the silicate liquid model of MELTS
(rhyolite-MELTS)
...
Uncomment here and in the next cell to generate a call graph that traces
execution times by method and module
...
Compute the system oxygen fugacity using Kress and Carmichael (1991)
along with the total moles of oxygen in the system
...
.. image:: 2-KandC-O2-Equilibrate_files/2-KandC-O2-Equilibrate_34_0.png
