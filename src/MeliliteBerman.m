...
@implementation Gehlenite

-(id)init {
	if ((self = [super initWithH:-3988158.0+18900.0
							  S:198.600
							 k0:373.09
							 k1:-22.768e2
							 k2:-47.785e5
...
@implementation IronAkermanite

-(id)init {
	if ((self = [super init])) {
		akermanite = [[BermanProperties alloc] initWithH:-3860441.0+4000.0
													   S:212.000
													  k0:387.06
													  k1:-29.388E2
													  k2:0.0
		...
		fayalite = [[BermanProperties alloc] initWithH:-1479360.0
													 S:150.930
													k0:248.93
													k1:-19.239E2
													k2:0.0
		...
		forsterite = [[BermanProperties alloc] initWithH:-2174420.0
													   S:94.010
													  k0:238.64
													  k1:-20.013E2
													  k2:0.0
...
-(double)getGibbsFreeEnergyFromT:(double)t andP:(double)p {
	return [akermanite getGibbsFreeEnergyFromT:t andP:p] + [fayalite getGibbsFreeEnergyFromT:t andP:p]/2.0
	 - [forsterite getGibbsFreeEnergyFromT:t andP:p]/2.0;
}
-(double)getEnthalpyFromT:(double)t andP:(double)p {
	return [akermanite getEnthalpyFromT:t andP:p] + [fayalite getEnthalpyFromT:t andP:p]/2.0
	 - [forsterite getEnthalpyFromT:t andP:p]/2.0;
}
-(double)getEntropyFromT:(double)t andP:(double)p {
	return [akermanite getEntropyFromT:t andP:p] + [fayalite getEntropyFromT:t andP:p]/2.0
	 - [forsterite getEntropyFromT:t andP:p]/2.0;
}
-(double)getHeatCapacityFromT:(double)t andP:(double)p {
	return [akermanite getHeatCapacityFromT:t andP:p] + [fayalite getHeatCapacityFromT:t andP:p]/2.0
	 - [forsterite getHeatCapacityFromT:t andP:p]/2.0;
}
-(double)getDcpDtFromT:(double)t andP:(double)p {
	return [akermanite getDcpDtFromT:t andP:p] + [fayalite getDcpDtFromT:t andP:p]/2.0
	 - [forsterite getDcpDtFromT:t andP:p]/2.0;
}
-(double)getVolumeFromT:(double)t andP:(double)p {
	return [akermanite getVolumeFromT:t andP:p] + [fayalite getVolumeFromT:t andP:p]/2.0
	 - [forsterite getVolumeFromT:t andP:p]/2.0;
}
-(double)getDvDtFromT:(double)t andP:(double)p {
	return [akermanite getDvDtFromT:t andP:p] + [fayalite getDvDtFromT:t andP:p]/2.0
	 - [forsterite getDvDtFromT:t andP:p]/2.0;
}
-(double)getDvDpFromT:(double)t andP:(double)p {
	return [akermanite getDvDpFromT:t andP:p] + [fayalite getDvDpFromT:t andP:p]/2.0
	 - [forsterite getDvDpFromT:t andP:p]/2.0;
}
-(double)getD2vDt2FromT:(double)t andP:(double)p {
	return [akermanite getD2vDt2FromT:t andP:p] + [fayalite getD2vDt2FromT:t andP:p]/2.0
	 - [forsterite getD2vDt2FromT:t andP:p]/2.0;
}
-(double)getD2vDtDpFromT:(double)t andP:(double)p {
	return [akermanite getD2vDtDpFromT:t andP:p] + [fayalite getD2vDtDpFromT:t andP:p]/2.0
	 - [forsterite getD2vDtDpFromT:t andP:p]/2.0;
}
-(double)getD2vDp2FromT:(double)t andP:(double)p {
	return [akermanite getD2vDp2FromT:t andP:p] + [fayalite getD2vDp2FromT:t andP:p]/2.0
	 - [forsterite getD2vDp2FromT:t andP:p]/2.0;
}

@end

@implementation SodaMelilite

-(id)init {
	if ((self = [super init])) {
		gehlenite = [[BermanProperties alloc] initWithH:-3988158.0+6700.0
													   S:198.600
													  k0:373.09
													  k1:-22.768E2
													  k2:-47.785E5
		...
		monalbite = [[BermanProperties alloc] initWithH:-3921618.0
													 S:224.412
													k0:393.64
													k1:-24.155E2
													k2:-78.928E5
...
-(double)getGibbsFreeEnergyFromT:(double)t andP:(double)p {
	return [gehlenite getGibbsFreeEnergyFromT:t andP:p] + 2.0*[monalbite getGibbsFreeEnergyFromT:t andP:p]
	- 2.0*[anorthite getGibbsFreeEnergyFromT:t andP:p];
}
-(double)getEnthalpyFromT:(double)t andP:(double)p {
	return [gehlenite getEnthalpyFromT:t andP:p] + 2.0*[monalbite getEnthalpyFromT:t andP:p]
	- 2.0*[anorthite getEnthalpyFromT:t andP:p];
}
-(double)getEntropyFromT:(double)t andP:(double)p {
	return [gehlenite getEntropyFromT:t andP:p] + 2.0*[monalbite getEntropyFromT:t andP:p]
	- 2.0*[anorthite getEntropyFromT:t andP:p];
}
-(double)getHeatCapacityFromT:(double)t andP:(double)p {
	return [gehlenite getHeatCapacityFromT:t andP:p] + 2.0*[monalbite getHeatCapacityFromT:t andP:p]
	- 2.0*[anorthite getHeatCapacityFromT:t andP:p];
}
-(double)getDcpDtFromT:(double)t andP:(double)p {
	return [gehlenite getDcpDtFromT:t andP:p] + 2.0*[monalbite getDcpDtFromT:t andP:p]
	- 2.0*[anorthite getDcpDtFromT:t andP:p];
}
-(double)getVolumeFromT:(double)t andP:(double)p {
	return [gehlenite getVolumeFromT:t andP:p] + 2.0*[monalbite getVolumeFromT:t andP:p]
	- 2.0*[anorthite getVolumeFromT:t andP:p];
}
-(double)getDvDtFromT:(double)t andP:(double)p {
	return [gehlenite getDvDtFromT:t andP:p] + 2.0*[monalbite getDvDtFromT:t andP:p]
	- 2.0*[anorthite getDvDtFromT:t andP:p];
}
-(double)getDvDpFromT:(double)t andP:(double)p {
	return [gehlenite getDvDpFromT:t andP:p] + 2.0*[monalbite getDvDpFromT:t andP:p]
	- 2.0*[anorthite getDvDpFromT:t andP:p];
}
-(double)getD2vDt2FromT:(double)t andP:(double)p {
	return [gehlenite getD2vDt2FromT:t andP:p] + 2.0*[monalbite getD2vDt2FromT:t andP:p]
	- 2.0*[anorthite getD2vDt2FromT:t andP:p];
}
-(double)getD2vDtDpFromT:(double)t andP:(double)p {
	return [gehlenite getD2vDtDpFromT:t andP:p] + 2.0*[monalbite getD2vDtDpFromT:t andP:p]
	- 2.0*[anorthite getD2vDtDpFromT:t andP:p];
}
-(double)getD2vDp2FromT:(double)t andP:(double)p {
	return [gehlenite getD2vDp2FromT:t andP:p] + 2.0*[monalbite getD2vDp2FromT:t andP:p]
	- 2.0*[anorthite getD2vDp2FromT:t andP:p];
}

@end

@implementation MeliliteBerman
...
#define NATOMS  12.0    /* Average number of atoms in the formula unit */

#pragma mark -
#pragma mark class methods

+(void)initialize {
	if (self == [MeliliteBerman class]) {
		...
		BermanProperties *akermanite = [[BermanProperties alloc] initWithH:-3860441.0+4900.0
																		 S:212.000
																		k0:387.06
																		k1:-29.388E2
																		k2:0.0
																	...
																	deltaH:452.0
																		...
																		v3:25.011E-6
																		v4:67.224E-10];
		[akermanite setPhaseFormula:@"Ca2MgSi2O7"];
		[akermanite setPhaseName:@"akermanite"];
		[mutableEndmembers addObject:akermanite];
		if (debug) NSLog(@"... allocated akermanite ...");

		Gehlenite *gehlenite = [[Gehlenite alloc] init];
		[mutableEndmembers addObject:gehlenite];
		if (debug) NSLog(@"... allocated gehlenite ...");

		IronAkermanite *ironAkermanite = [[IronAkermanite alloc] init];
		[ironAkermanite setPhaseFormula:@"Ca2FeSi2O7"];
		[ironAkermanite setPhaseName:@"iron-akermanite"];
		[mutableEndmembers addObject:ironAkermanite];
		if (debug) NSLog(@"... allocated iron-akermanite ...");

		SodaMelilite *sodaMelilite = [[SodaMelilite alloc] init];
		[sodaMelilite setPhaseFormula:@"Na2Si3O7"];
		[sodaMelilite setPhaseName:@"soda-melilite"];
		[mutableEndmembers addObject:sodaMelilite];
		if (debug) NSLog(@"... allocated soda-melilite ...");
...
-(id)init {
	if ((self = [super init])) {
		BOOL debug = false; // [[NSUserDefaults standardUserDefaults] boolForKey:@"DEBUG.SATLOOP.VERBOSE"];
		if (debug) NSLog(@"init(MeliliteBerman) ... entry ...");
		[self setPhaseName:@"Melilite"];
			 ...
			 dp2:(double [NS])dp2	// d2s[NS]/dp2 BINARY MASK: 100000
{
	...
	if ( (t != tOldPure) || (p != pOldPure) ) {
		...
		for (i=0; i<NS; i++) { sOldPure[i] = 2.0; sNew[i] = 0.1; }
		...
		if (debug) {
			for (i=0; i<NS; i++) {
				if (dgds[i] > sqrt(DBL_EPSILON) && fabs(sOld[i]) > DBL_EPSILON) {
					NSLog(@"ERROR in MELILITE.C (function ORDER). Failed to converge!\n");
					NSLog(@"  X Gh  = %13.6g, X2 Fe-Ak = %13.6g, X3 Na = %13.6g\n", r[0], r[1], r[2]);
					NSLog(@"  s     = %13.6g\n", sOld[0]);
					NSLog(@"  dgds1 = %13.6g\n", dgds[0]);
					NSLog(@"  X Na oct: %13.6g  X Ca Oct: %13.6g\n", xNaOct, xCaOct);
					NSLog(@"  X Mg2+T1: %13.6g  X Fe2+T1: %13.6g\n", xMg2T1, xFe2T1);
					NSLog(@"  X Al3+T1: %13.6g  X Si4+T1: %13.6g\n", xAl3T1, xSi4T1);
					NSLog(@"  X Al3+T2: %13.6g  X Si4+T2: %13.6g\n", xAl3T2, xSi4T2);
					break;
				}
			}
		}
		   ...
		   d3m:(double [NR][NA][NA][NA])d3m // 3rd deriv matrix: d3m[i][j][k][l]=d3r[i]/dm[j]dm[k]dm[l]
{
	...
	if (inpMask == FIRST && outMask == SECOND) {
		...
		if (outMask & ~(THIRD | FOURTH | FIFTH | SIXTH | EIGHTH))
			NSLog(@"Illegal call to conMel with inpMask = %o and outMask = %o\n",  inpMask, outMask);
						  ...
						  r:(double [NA])r
{
	...
	return [NSString stringWithFormat:@"Na%4.2fCa%4.2fAl%4.2fMg%4.2fFe%4.2fSi%4.2fO7", totNa, totCa, totAl, totMg, totFe2, totSi];
}
...
-(NSString *)nameOfSolutionSpeciesAtIndex:(NSUInteger)index {
	switch (index) {
		...
		case 1:
			...
			break;
		case 2:
			return @"iron-akermanite";
			break;
		case 3:
			return @"soda-melilite";
			break;
		default:
			return @"";
			break;
