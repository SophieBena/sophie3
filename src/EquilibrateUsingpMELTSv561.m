...
#import "EquilibrateUsingpMELTSv561.h"
...
@implementation EquilibrateUsingpMELTSv561
...
- (instancetype)init {
    [[NSUserDefaults standardUserDefaults] setInteger:2 forKey:@"PPCalculationDatabase"];
    self = [super initWithInformationalDebug:NO
               ...
               andDictionaryOfPhasesInSystem:[NSDictionary dictionaryWithObjectsAndKeys:
                    [self allocatePhaseWithName:@"Liquid"         phaseClass:[LiquidpMelts class]        ], @"Liquid",
                    ...
                    [self allocatePhaseWithName:@"Water"          phaseClass:[WaterpMelts class]          ], @"Water",
