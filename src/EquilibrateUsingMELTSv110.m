...
#import "EquilibrateUsingMELTSv110.h"
...
@implementation EquilibrateUsingMELTSv110
...
- (instancetype)init {
    ...
    self = [super initWithInformationalDebug:NO
               ...
               andDictionaryOfPhasesInSystem:[NSDictionary dictionaryWithObjectsAndKeys:
                    [self allocatePhaseWithName:@"Liquid"         phaseClass:[LiquidMeltsPlusOldH2OandNewCO2 class]], @"Liquid",
                    ...
                    [self allocatePhaseWithName:@"Fluid"          phaseClass:[FluidDuan class]                     ], @"Fluid",
