...
static double H_TrPr = -6284740.0;
static double S_TrPr = 268.8;
static double k0 = 590.9;
static double k1 = -2827.0;
static double k2 = -13320800;
static double k3 = 1260330000;
static double V_TrPr = 11.311;
static double v1 = -5.76e-07;
static double v2 = 4.42e-13;
static double v3 = 2.2519e-05;
static double v4 = 3.7044e-09;
...
const char *Pyrope_Garnet_calib_identifier(void) {
    return identifier;
}

const char *Pyrope_Garnet_calib_name(void) {
    return "Pyrope";
}

const char *Pyrope_Garnet_calib_formula(void) {
    return "Mg3Al2Si3O12";
}

const double Pyrope_Garnet_calib_mw(void) {
    return 403.12738;
}
...
const double *Pyrope_Garnet_calib_elements(void) {
    return elmformula;
}
...
int Pyrope_Garnet_get_param_number(void) {
    return Garnet_get_param_number();
}

const char **Pyrope_Garnet_get_param_names(void) {
    return Garnet_get_param_names();
}

const char **Pyrope_Garnet_get_param_units(void) {
