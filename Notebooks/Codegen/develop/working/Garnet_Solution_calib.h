...
static double Garnet_Solution_dparam_g(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_dgdt(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_dgdp(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d2gdt2(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d2gdtdp(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d2gdp2(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d3gdt3(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d3gdt2dp(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d3gdtdp2(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static double Garnet_Solution_dparam_d3gdp3(double T, double P, double n[3], int index) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    double result = 0.0;
...
static void Garnet_Solution_dparam_dgdn(double T, double P, double n[3], int index, double result[3]) {
    double n1 = n[0];
    double n2 = n[1];
    double n3 = n[2];
    switch (index) {
...
static int Garnet_Solution_get_param_number(void) {
    return 23;
}
...
static const char **Garnet_Solution_get_param_names(void) {
    return paramNames;
}

static const char **Garnet_Solution_get_param_units(void) {
    return paramUnits;
}

static void Garnet_Solution_get_param_values(double **values) {
    (*values)[0] = T_r;
    (*values)[1] = P_r;
    (*values)[2] = Wh12;
    (*values)[3] = Ws12;
...
static int Garnet_Solution_set_param_values(double *values) {
    T_r = values[0];
    P_r = values[1];
    Wh12 = values[2];
    Ws12 = values[3];
...
static double Garnet_Solution_get_param_value(int index) {
    double result = 0.0;
    switch (index) {
    case 0:
        result = T_r;
...
static int Garnet_Solution_set_param_value(int index, double value) {
    int result = 1;
    switch (index) {
    case 0:
        T_r = value;
