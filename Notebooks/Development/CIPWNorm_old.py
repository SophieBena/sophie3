...
def CIPW_norm(oxide_wts):
    ...
    # Step 8c
        ...
        # Step 8d/e: converts hypersthene to olivine, Ttn -> perovskite
        else:
            ...
            # convert albite + silica to  albite + nepheline
            ...
            # Step 8f
                ...
                # convert all albite to nepheline
                ...
                if oxide_mols['SiO2'] >= 4.0*min_mols['Or']:
                    # convert some Orthoclase to Leucite
                ...
                # Step 8g
                    ...
                    if ((oxide_mols['SiO2']+min_mols['Wo']) <
                        4*min_mols['Or']):
                        # convert all orthoclase to leucite
                        ...
                        if ((oxide_mols['SiO2']+min_mols['Wo']
                            ...
                            oxide_mols['SiO2'] = (
                                ...
                                - min_mols['Wo']*0.5
                                + min_mols['Lct']*4.0)
                            # convert all Diopside + wollastonite to Ca-orthosilicate + olivine
                            min_mols['CaOrsi'] = (
                            ...
                            min_mols['Wo'] = 0.0
                            min_mols['Di'] = 0.0
                            # convert some leucite to Kaliophilite
                            #   Lct and Klpl coefs?
                            ...
                            # convert diopside + wollastonite + SiO2
                            #   to Di + olivine + Ca-orthosilicate
                        ...
                        # convert Orthoclase + leucite + SiO2
                        #   to Ca-orthosilicate + wollastonite???
                        min_mols['Lct'] = min_mols['Or']
                        min_mols['Or'] = 0.0
    ...
    # distribute Mg/Fe amongst endmembers
    ...
    for mineral_sym in mineral_info['molwts']:
        molwt = mineral_info['molwts'][mineral_sym]
        min_mols[mineral_sym] *= molwt

    min_mols['Di'] = min_mols['Di'] + min_mols['Hd']
    min_mols['Hyp'] = min_mols['En'] + min_mols['Fs']
    min_mols['Ol'] = min_mols['Fo'] + min_mols['Fa']
    min_mols['Hd'] = 0.0
    min_mols['En'] = 0.0
    min_mols['Fs'] = 0.0
    min_mols['Fo'] = 0.0
